...
module.exports = function (dict) {
    this
        ...
        .then(/^I expect that link "$string" becomes( not)* visible$/,
            require('../support/action/waitForVisibleLink'))
        ...
        .then(/^I wait a little more$/,
            require('../support/action/justwait'))
        ...
        .then(/I expect that a screenshot named "$string" exists$/,
            require('../support/action/takeScreenshot'));
};
