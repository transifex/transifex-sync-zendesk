...
var syncCategories = module.exports = {
  ...
  eventHandlers: {
    uiSyncPageCategoriesInit: function() {
      ...
      this.switchTo('sync_page_categories', { dataset: pageData, });
    ...
    uiSyncCategories: function(event) {
      event.preventDefault();
        ...
        this.asyncGetZdCategoriesFull(syncCategories.currentpage ,syncCategories.sortby, syncCategories.sortdirection, syncCategories.perpage);
      ...
      for (var i = 0; i < completedLocales.length; i++) { // iterate through list of locales
        if (sourceLocale !== completedLocales[i]) { // skip the source locale
          ...
          if (typeof translation.content === 'string') {
            ...
            this.zdUpsertCategoryTranslation(translation.content, zdObjectId, zdLocale);
         }
        }
      }
    },
  ...
  actionHandlers: {
      ...
      syncCategoryTranslations: function() {
        ...
        var OKToGetCategoryTranslations = (typeof categoryData === 'undefined')?false:true;
      ...
      syncResourceStats: function() {
        ...
        var categoryData = this.store(zdCategory.key);
        var OKToGetResourceStats = (typeof categoryData === 'undefined')?false:true;
        var obj, numCategories;
