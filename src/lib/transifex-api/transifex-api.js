...
import superagent from './polyfills/superagent';
import superagentpromise from './polyfills/superagent-promise';
var objectAssign = require('./polyfills/object-assign.js').objectAssign;
...
TransifexApi.request = {}
TransifexApi.md5 = md5;

TransifexApi.api = objectAssign(TransifexApi,
 projectMixin,
 resourceMixin,
 resourceStringMixin,
 languageMixin,
